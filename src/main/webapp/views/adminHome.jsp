			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<a href="/admin/books" class="card-link btn btn-primary">Manage</a>
			...
			<div class="col-sm-3 pt-4">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<p>---------------------------------------------</p>
						<p class="card-text">Manage all the members here.</p>
						<a href="/admin/members" class="card-link btn btn-primary">Manage</a>
